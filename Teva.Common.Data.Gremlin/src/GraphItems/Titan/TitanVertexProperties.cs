...
{
    /// <summary>
    /// Titan-Implementation of IVertexProperties, derives from Dictionary
    /// </summary>
    public class TitanVertexProperties : Dictionary<string, List<IVertexValue>>, IVertexProperties
    {
        /// <summary>
        ...
        public void SetProperty<T>(string Key, T Value, bool IgnoreDefaultValue = true)
        {
            ...
            if (Value == null || (IgnoreDefaultValue && EqualityComparer<T>.Default.Equals(Value, default(T))))
                ...
                base[Key] = new List<IVertexValue> { new TitanVertexValue(Value) };
        }
        /// <summary>
        /// Sets a property with key and value
        /// </summary>
